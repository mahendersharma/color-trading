...
const ParentComponent = () => {
  ...
  return (
    <>
      {allSelectedValues.map((selectedValues, index) => (
        <div key={index}>
          ...
          {allSelectedValues.length > 1 ? (
            <Button onClick={() => handleRemoveClick(index)} color="danger" style={{
              marginLeft: '10px', backgroundColor: '#f5365c',
              color: 'white',
              borderRadius: '50%',
              margin: '9px',
              width: '60px',
      ...
      <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={handleAddClick}>
      <i className="fa fa-plus-circle" aria-hidden="true" style={{ marginRight: '5px' }} /> Add
      </button>

      <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={printAllSelectedValues}>        Print All Selected Values
      </button>
            </div>
